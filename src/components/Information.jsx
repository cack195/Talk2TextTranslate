...
export default function Information(props) {
  ...
  function handleDownload() {
    ...
    element.download = `Talk2TextTranslate_${new Date().toString()}.txt`;
  ...
  return (
    <main className="flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 max-w-prose w-full mx-auto">
      ...
      <div className="grid grid-cols-2 sm:mx-auto bg-white  rounded overflow-hidden items-center p-1 greenShadow border-[2px] border-solid border-green-300">
        <button
